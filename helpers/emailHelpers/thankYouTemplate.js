const generateThankYouTemplate = () => `
  ...
  <html>
    <body style="font-family: Arial, sans-serif; background-color: #ECECEC; color: #595959;">
      <div style="width: 100%; max-width: 600px; margin: 20px auto;padding: 20; background-color: #ffffff; border: 1px solid #ddd; border-radius: 10px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); overflow: hidden;">
        <!-- Header -->
        <div style="background-color: #9866C7; color: #fff; text-align: center; padding: 10px; font-weight: bold;">
          <h1>GenX Career</h1>
          <div style="font-size: 16px;">Thank You for Contacting Us.</div>
        </div>
        <!-- Body -->
        <div style="padding: 30px; background-color: #f9f9f9; font-size: 16px; line-height: 1.8;">
          <p style="margin: 0 0 15px;">Hi, Thank you for reaching out to <strong>GenX Career</strong>. We have received your message and our team will get back to you shortly.</p>
          <p style="margin: 0 0 15px;">We are excited to help you explore <b>IT job opportunities</b> across multiple platforms and assist you with CV generation to match jobs with your skills.</p>
